...
export default function Features() {
  return (
    <section className="w-full text-[#F3ECE5] px-12 py-32 flex flex-col items-center">
      <div className="w-full max-w-[1200px]">
        <h2 className="font-serif text-[2.5rem] leading-[1.2] font-[500] tracking-tight mb-24">
          ...
          <div className="flex flex-col items-center text-center flex-1">
            <div className="mb-8 h-12 flex items-center justify-center">
              <svg 
                ...
                fill="none" stroke="#C9A470" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"
              >
            ...
            <p className="text-[14px] text-[#F3ECE5] opacity-[58%] leading-[1.6] max-w-[200px]">
